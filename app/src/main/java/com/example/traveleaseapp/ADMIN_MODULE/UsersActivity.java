...
import com.example.traveleaseapp.ADAPTOR.AdminUsersAdaptor;
...
public class UsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userlist=findViewById(R.id.user);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new AdminUsersAdaptor(UsersActivity.this, arrayList);
                    userlist.setAdapter(adap);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AdminViewUsers");
                return map;
            }
        };
        queue.add(request);
