...
public class VehicleFragment extends Fragment {
    ...
    public ProviderVehicleAdaptor adap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        packlist =root.findViewById(R.id.vehi);
        add=root.findViewById(R.id.add);

        ViewVehicles();
        add.setOnClickListener(v -> {
            Intent i=new Intent(getContext(),AddVehicles.class);
            startActivity(i);
        });
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new ProviderVehicleAdaptor(requireActivity(), arrayList);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "ProViewVehicles");
                map.put("proid", uid);
                return map;
            }
        };
